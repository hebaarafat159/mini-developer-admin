...
export default function ConfirmationPage() {
    ...
    let text = (pageTitle === "feedback") ? "Thanks for sharing your Feedback With us" : "Thanks for your interest in Mini Developer courses. We received your registration and a member of the team will be in touch with you soon! ";
    return (
            ...
            <Stack direction="column" spacing={2} sx={{ justifyContent: 'center', alignItems: 'center', background: 'white', padding: '3vw' }} >
                <Stack direction="row" width={'80%'} sx={{ justifyContent: 'center', alignItems: 'center', background: 'white', padding: '2vw' }} >
                    ...
                    <Stack direction="column" >
                        ...
                        <Typography component="h3" variant='h5' style={{ color: '#4682b4', textAlign: 'left', fontWeight: 'bold', padding: '1vmin' }}>{text}</Typography>
                    </Stack>
                </Stack>
